...
class SessionRepository
{
    ...
    public function save(Session $session, $connection): Session {
    ...
    public function deleteById(string $id, $statement):void {
        $this->connection->prepare("DELETE FROM sessions WHERE id = ?");
        $statement->execute([$id]);
